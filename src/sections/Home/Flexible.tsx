  ...
  return (
    <div className="py-20 container flex gap-16 items-center">
        ...
        <div className="flex-[1.1]">
            <h3 className="text-3xl font-bold pb-2"> To make therapy as accessible and comfortable as possible, I offer flexible options to suit your needs. </h3>
            ...
            <div className="text-primaryText text-xl flex gap-2 mb-4"> <div className="flex-1">{star}</div> <p> Walking side-by-side can create a less confrontational and more relaxed atmosphere, potentially making it easier to discuss complex or sensitive topics. </p> </div>
            <div className="text-primaryText text-xl flex gap-2 mb-2"> <div className="flex-1">{star}</div> <p> The gentle physical activity can also reduce anxiety and stress, release endorphins that boost mood, and enhance cognitive function and creative thinking. </p> </div>
