  ...
  return (
    <div className='py-8 sm:py-20 container'>
        ...
        <div className="flex flex-col md:flex-row gap-10 mb-10">
            <div className="py-6 px-6 md:px-10 rounded-2xl flex flex-col gap-2 items-start bg-textPrimary flex-1 relative">
                <h1 className="text-lg md:text-2xl font-semibold">Individual Therapy</h1>
                <p className="text-sm md:text-lg text-start mb-4"> One-on-one sessions focused on your specific needs and goals. Together, we'll work through challenges such as anxiety, depression, stress, relationship issues, or major life transitions. </p>
                {/* Features */}
            ...
            <div className="py-6 px-6 md:px-10 rounded-2xl flex flex-col gap-2 items-start bg-textPrimary flex-1 relative">
                ...
                <p className="text-sm md:text-lg text-start mb-4"> Focused therapeutic approaches for specific challenges you may be facing, including expat adjustment, cultural transition, and identity exploration. </p>
                {/* Features */}
                <div className='flex flex-col gap-2 mb-6'>
