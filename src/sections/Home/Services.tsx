    ...
    <div className='py-0 sm:py-20 container'>
        ...
        <div className="flex flex-col md:flex-row gap-10 mb-10">
            ...
            <div className="py-6 px-6 md:px-10 rounded-2xl flex flex-col gap-2 items-start bg-textPrimary flex-1 relative group overflow-hidden" ref={rightBox}>
                ...
                <p className="text-sm md:text-lg text-start mb-4 relative z-[2]"> Focused therapeutic approaches for specific challenges you may be facing, including expat adjustment, cultural transition, and identity exploration. </p>
                {/* Features */}
                <div className='flex flex-col gap-2 mb-6 z-[2]'>
