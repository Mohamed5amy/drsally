...
const Main = () => {
  return (
    <div className="container pt-10 pb-20 flex flex-col-reverse md:flex-row items-center gap-14 justify-between">
        <div className="flex-[1.2]">
            <h1 className="text-primaryText text-[32px] md:text-[48px] xl:text-[60px] font-bold mb-2 leading-[40px] md:leading-[60px] xl:leading-[80px]">Feeling Overwhelmed and Stuck? You're Not Alone.</h1>
